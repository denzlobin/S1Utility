...
//   0-255  â†’ CC 0-127  (ccValue = prmValue * 127 / 255, rounded)
//   0-127  â†’ CC 0-127  (direct, 1:1)
//   0-100  â†’ CC 0-127  (ccValue = prmValue * 127 / 100, rounded)
//   0-1    â†’ CC 0-127  (flag: 0â†’0, any positiveâ†’127, because Clamp(n,0,1)=1 for nâ‰¥1)
// Reverse follows the same formula inverted.
// CcMin lets parameters with a non-zero CC floor (e.g. OSC_CHOP_COMB: CC 3â€“127) be represented.
...
public static class PrmCcMap
{
    ...
    public static readonly IReadOnlyDictionary<string, PrmParameterInfo> Map =
        ...
        {
            // â”€â”€ LFO â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
            { "LFO_RATE",               P(3,   0,   255) },
            ...
            // â”€â”€ Voice / Polyphony â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
            ...
            { "CHORD_VOICE2_SW",        P(81,  0,   1)   },   // flag: 0â†’CC0, >0â†’CC127
            ...
            // â”€â”€ Oscillator â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
            ...
            { "FINE_TUNE",              P(76,  0,   255) },   // 128 in PRM â†’ CC 64
            { "NOISE_MODE",             P(78,  0,   127) },
            { "OSC_DRAW_MULT",          P(102, 7,   255, 3) }, // PRM 7â€“255 â†’ CC 3â€“127; PRM 7 = hardware init = CC 3 = display 1.0
            { "OSC_CHOP_OVERTONE",      P(103, 0,   255) },   // PRM 0-255 native; display 0-200 via cc*255/127, capped 200
            { "OSC_CHOP_COMB",          P(104, 7,   255, 3) }, // PRM 7â€“255 â†’ CC 3â€“127; PRM 7 = hardware init = CC 3 = display 1.0
            ...
            { "VCF_CUTOFF",             P(74,  0,   255) },   // init=255 â†’ CC127 (fully open)

            // â”€â”€ Envelope â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // CC number â†’ (PRM key, scaling info) â€” used by the PRM file writer.
